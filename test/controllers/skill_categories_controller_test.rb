...
class SkillCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create skill_category" do
    assert_difference('SkillCategory.count') do
      post skill_categories_url, params: { skill_category: { skill_category_name: @skill_category.skill_category_name, sort_order: @skill_category.sort_order } }
    end
  ...
  test "should update skill_category" do
    patch skill_category_url(@skill_category), params: { skill_category: { skill_category_name: @skill_category.skill_category_name, sort_order: @skill_category.sort_order } }
