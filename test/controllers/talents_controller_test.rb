...
class TalentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create talent" do
    assert_difference('Talent.count') do
      post talents_url, params: { talent: { learning_level: @talent.learning_level, skill_id: @talent.skill_id, user_id: @talent.user_id } }
    end
  ...
  test "should update talent" do
    patch talent_url(@talent), params: { talent: { learning_level: @talent.learning_level, skill_id: @talent.skill_id, user_id: @talent.user_id } }
