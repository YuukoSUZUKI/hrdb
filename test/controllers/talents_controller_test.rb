...
class TalentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create talent" do
    assert_difference('Talent.count') do
      post talents_url, params: { talent: { birth: @talent.birth, memo: @talent.memo, name: @talent.name, speciality: @talent.speciality } }
    end
  ...
  test "should update talent" do
    patch talent_url(@talent), params: { talent: { birth: @talent.birth, memo: @talent.memo, name: @talent.name, speciality: @talent.speciality } }
